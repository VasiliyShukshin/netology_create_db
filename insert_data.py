import sqlalchemy
db = 'postgresql://shukshin:Gjkmpjdfntkm12!@localhost:5432/homeworke'
...
track_list = connection.execute(
    ...
    insert into track_list(albom_id, track_name, track_duration) VALUES('7', 'Thunder', 300);
    """
)
